...
{
    // create window with nSetChatbotHandleame and show it
    ...
    : wxScrolledWindow(parent, id)
{
    ...
    // allow for PNG images to be handled0
    ...
    _chatLogic = std::make_unique<ChatLogic>(); // Create smart pointer instance of _chatLogic. Task 1.
...
ChatBotPanelDialog::~ChatBotPanelDialog()
{
    ...
    // delete _chatLogic; // Removed delete since we are using a smart pointer for _chatLogic. Task 1.
