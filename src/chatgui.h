...
private:
    ...
    //// STUDENT CODE: Task 1
    ////
    // ChatLogic *_chatLogic; // This makes _chatLogic a raw pointer.
    std::unique_ptr<ChatLogic> _chatLogic; // this declares a unique smart pointer for the _chatLogic member. Task 1.
...
public:
    ...
    return _chatLogic.get(); // return address of smart pointer. Task 1.
    }
