# PJG-CppND-Memory-Management-Chatbot

Memory Management Chatbot project for the Memory Management course in the [Udacity C++ Nanodegree Program](https://www.udacity.com/course/c-plus-plus-nanodegree--nd213).
...
The original student code repository contained a working chatbot, however, there were no smart pointers, no move semantics and there were ownership and memory allocation that needed to be resolved. In this repository, the chatbot has been optimized from a memory management perspective, using the concepts from the Memory Management course. There were five specific tasks completed, which are detailed below.
...
**The following details the project tasks that were presented by Udacity regarding the student repository code.**
